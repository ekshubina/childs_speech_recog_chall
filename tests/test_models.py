...
class TestWhisperModel:
    ...
    def test_transcribe_batch_audio(self, mock_librosa, mock_processor_class, mock_model_class):
        ...
        # Mock processor output
        mock_inputs = {"input_features": torch.randn(2, 80, 3000)}
        mock_processor.return_value = mock_inputs
        ...
        with tempfile.NamedTemporaryFile(suffix=".wav") as tmp_file1, tempfile.NamedTemporaryFile(suffix=".wav") as tmp_file2:
...
class TestPrepareModelForFinetuning:
    ...
    def test_prepare_model_basic_configuration(self):
        ...
        result = prepare_model_for_finetuning(
            mock_model, freeze_encoder=False, dropout=0.1, language="english", task="transcribe"
        )
    ...
    def test_prepare_model_freeze_encoder(self):
        ...
        prepare_model_for_finetuning(mock_model, freeze_encoder=True, dropout=0.05)
    ...
    def test_prepare_model_different_languages(self):
        ...
        prepare_model_for_finetuning(mock_model, language="spanish", task="translate")
...
class TestModelFactory:
    ...
    def test_factory_creates_whisper_model(self):
        ...
        config = {"model": {"name": "whisper", "variant": "small", "pretrained": "openai/whisper-small"}}
    ...
    def test_factory_with_explicit_device(self):
        ...
        config = {"model": {"name": "whisper", "variant": "small", "device": "cpu"}}
    ...
    def test_factory_case_insensitive_model_name(self):
        ...
        config = {"model": {"name": "WHISPER", "variant": "tiny"}}
    ...
    def test_factory_unknown_model_raises_error(self):
        ...
        config = {"model": {"name": "unknown_model", "variant": "large"}}
...
class TestModelIntegration:
    ...
    @patch("src.models.whisper_model.WhisperProcessor")
    @patch("librosa.load")
    def test_full_pipeline_with_factory(self, mock_librosa, mock_processor_class, mock_model_class, tmp_path):
        ...
        # Create config
        config = {"model": {"name": "whisper", "variant": "tiny", "pretrained": "openai/whisper-tiny", "device": "cpu"}}
