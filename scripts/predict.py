...
Usage:
    python scripts/predict.py --model-path checkpoints/finetuned_model --input-jsonl data/test.jsonl --output-jsonl predictions.jsonl
    python scripts/predict.py --model-path checkpoints/finetuned_model --input-jsonl data/test.jsonl --output-jsonl predictions.jsonl --batch-size 32
"""
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description='Generate predictions using trained Whisper model'
    )
    parser.add_argument(
        '--model-path',
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help='Path to output JSONL predictions file'
    )
    parser.add_argument(
        '--audio-dirs',
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help='Path to log file (default: logs/predict_{timestamp}.log)'
    )
    parser.add_argument(
        '--no-progress',
        action='store_true',
